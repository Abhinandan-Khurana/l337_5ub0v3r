...
\t\t         _  _____  _____  ___________       _     _____       _____      
\t\t        | ||____ ||____ ||___  /  ___|     | |   |  _  |     |____ |     
\t\t        | |    / /    / /   / /|___ \ _   _| |__ | |/' |_   __   / /_ __ 
\t\t        | |    \ \    \ \  / /     \ \ | | | '_ \|  /| \ \ / /   \ \ '__|
\t\t        | |.___/ /.___/ /./ /  /\__/ / |_| | |_) \ |_/ /\ V /.___/ / |   
\t\t        |_|\____/ \____/ \_/   \____/ \__,_|_.__/ \___/  \_/ \____/|_|   
\t\t                         ______                                          
\t\t                        |______|                                                                                                                                                                                                                                                                                                                            
...
def main():
    ...
    if args.domain:
        ...
        print('usage: l337_5ub0v3r.py [-h] [-d DOMAIN] [-f FILE] [-o OUTPUT] [-p PROTOCOL]')
